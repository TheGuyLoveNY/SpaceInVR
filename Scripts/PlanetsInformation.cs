...
public class PlanetsInformation : MonoBehaviour
{
    ...
    private string JupiterFacts = "1. Jupiter is so big that all the other planets in the solar system could fit inside it or 1,300 Earths.\n2. Jupiter has a faint ring system around it.\n3. Jupiter’s Great Red Spot is an enormous storm that has been raging for over 300 years.";
    private string SaturnFacts = "1. Saturn is one of five planets able to be seen with the naked eye.\n2. Saturn has the fastest winds in our solar system with 1,800 km/ 1,118 miles per hour(Four times faster than the strongest wind in the Earth's history).\n3. Saturn is 1,424,600,000 km (0,9 billion miles) from the Sun.";
    ...
    private void PlayAudio()
    {
        ...
        {
            thePlayer.Stop();
            thePlayer.PlayOneShot(currentAudioClip);
        }
    ...
    public void ToMenu()
    {
      ...
      2. Disable the computer screen and the current planet.
      3. Enable the Menu Screen.
      */
      StopAudio();
